...
@app.route("/")
def home():
    return "بوت تحميل فيديوهات فيسبوك يعمل بنجاح"
    ...
    for entry in data.get('entry', []):
        for messaging_event in entry.get('messaging', []):
            ...
            if messaging_event.get('message') and 'text' in messaging_event['message']:
                ...
                if message_text and "facebook.com" in message_text:
                    # تنفيذ yt-dlp لجلب رابط الفيديو
                    ...
                    if video_url:
                        ...
                        send_message(sender_id, "عذرًا، لم أتمكن من استخراج رابط الفيديو.")
    return "تم", 200
